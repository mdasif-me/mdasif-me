...
<div style="display: flex; justify-content: center; align-items: center; border: 2px solid #ccc; border-radius: 10px; padding: 10px 20px; background-color: #f7f7f7; font-size: 16px; color: #333;">
  <span style="font-weight: bold; margin-right: 10px;">👀 Profile Views:</span>
  <span id="view-count" style="font-size: 18px; font-weight: bold; color: #5c6bc0;">0</span>
</div>
