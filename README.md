...
<table style="width: 100vw; border-collapse: collapse; margin: 0; padding: 0;"> <tr> <th style="padding: 10px; text-align: left;"> <h3>Current Projects</h3> </th> </tr> <tr> <td style="padding: 10px 20px; text-align: left;"> 1. <strong>Enterprise Backend Architecture</strong>: Building robust systems for seamless automation.<br> 2. <strong>Office Management System</strong>: Enhancing workflows with <a href="https://github.com/InterlinkTechnologiesLtd/office-management-system">GitHub</a>. </td> </tr> <tr> <th style="padding: 10px; text-align: left;"> <h3>Skill Development</h3> </th> </tr> <tr> <td style="padding: 10px 20px; text-align: left;"> 1. <strong>Advanced System Design</strong>: Focusing on optimization and scalability.<br> 2. <strong>CSE Fundamentals</strong>: Strengthening skills with <a href="https://phitron.io/">Phitron</a>. </td> </tr> <tr> <th style="padding: 10px; text-align: left;"> <h3>Technical Expertise</h3> </th> </tr> <tr> <td style="padding: 10px 20px; text-align: left;"> 1. <strong>Languages & Frameworks</strong>: Java, Python, TypeScript, Next.js, Spring Boot, Nest.js<br> 2. <strong>Cloud & DevOps</strong>: AWS, Docker, Kubernetes, CI/CD Pipelines<br> 3. <strong>Databases & Tools</strong>: PostgreSQL, MySQL, MongoDB, Redis, Prisma<br> 4. <strong>Specialization</strong>: Optimizing performance and scaling systems </td> </tr> <tr> <th style="padding: 10px; text-align: left;"> <h3>Discussion Topics</h3> </th> </tr> <tr> <td style="padding: 10px 20px; text-align: left;"> 1. <strong>Scalable Web Solutions</strong>: Architecture, caching, microservices<br> 2. <strong>Backend Engineering</strong>: APIs, database design, best practices<br> 3. <strong>Tech Leadership</strong>: Planning, code reviews, execution </td> </tr> </table>
